...
class Window(QtWidgets.QWidget):
    ...
    def initSignals(self) -> None:
        ...
        self.pushButtonPlainTextEdit.clicked.connect(self.onPushButtonPlaineTextEditClicked)  # TODO подключить слот для вывода текста из plaineTextEdit в plainTextEditLog при нажатии на кнопку
        ...
        self.pushButtonClearLog.clicked.connect(self.clearPlainTextEditLog)  # TODO подключить слот для очистки plainTextEditLog при нажатии на кнопку
    ...
    def onPushButtonComboBoxClicked(self) -> None:
        ...
        self.plainTextEditLog.setPlainText(self.comboBox.itemText(self.comboBox.currentIndex()))
    ...
    def onPushButtonPlaineTextEditClicked(self) -> None:
        """
        Обработка сигнала clicked для кнопки pushButtonPlaineTextEdit
    ...
    def clearPlainTextEditLog(self) -> None:
        """
